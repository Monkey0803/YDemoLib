#
#  Be sure to run `pod spec lint YDemoLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Monkey's Dad" => "hu_1987@126.com" }
  # Or just: spec.author    = "Monkey's Dad"
  # spec.authors            = { "Monkey's Dad" => "hu_1987@126.com" }
  # spec.social_media_url   = "https://twitter.com/Monkey's Dad"
